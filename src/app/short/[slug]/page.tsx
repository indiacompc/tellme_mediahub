		...
		<>
			...
			<div className='w-full p-0'>
				...
				<div className='absolute top-24 left-4 z-30 mb-4 lg:static lg:top-auto lg:left-auto lg:z-auto lg:mt-6 lg:mb-6 lg:ml-6'>
					<Link
						href={backHref}
						className='lg:text-muted-foreground lg:hover:text-foreground inline-flex items-center gap-2 rounded-lg bg-black/50 px-3 py-2 text-sm text-white backdrop-blur-sm transition-colors hover:bg-black/70 sm:text-base lg:bg-transparent lg:px-0 lg:py-0 lg:backdrop-blur-none'
					>
